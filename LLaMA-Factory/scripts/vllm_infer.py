...
def vllm_infer(
    ...
    with open(
        os.path.join(output_dir, "generated_predictions.jsonl"), "w", encoding="utf-8"
    ) as f:
    ...
    print("*" * 70)
    print(
        f"{len(prompts)} generated results have been saved at {os.path.join(output_dir, "generated_predictions.jsonl")}."
    )
    print("*" * 70)
